						...
						<article class="bc-content-component bc-areas-of-practice__main bc-match-height-wrap">
							<div class="bc-area-of-practice__area bc-areas-of-practice__main__area bc-match-height">
								<div class="bc-area-of-practice__area__header">
									<svg class="svg-icon bc-area-of-practice__area__icon">
										<use xlink:href="assets/media/svg/icons/bc-svgs.svg#litigation"></use> 
									</svg>	
									<h3 class="bc-area-of-practice__area__heading"><?php echo $this_area_of_practice['area-title']; ?></h3>
									<?php if($this_area_of_practice['area-title']) { ?>
									<p class="bc-area-of-practice-leader-para">家庭法需要在理解客户需求和满足客户期望之间取得平衡，同时以实用和非对抗的方式寻求解决方案。我们的律师可以从头到尾指导您完成整个过程，我们的目标是为您提供专家建议，以便我们以最小的痛苦和压力为您取得最佳结果。 我们的团队拥有必要的专业知识、经验和对家庭法实践和发展的承诺。</p>
									<?php } ?>
									<p>我们家庭法业务的具体领域包括：离婚，司法分离，分居协议，维护、保管和访问问题，财产和资产纠纷，赡养费等等</p>
