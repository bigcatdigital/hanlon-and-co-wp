...
?> 
	...
	<div class="bc-has-border-rad__wrap">
		<section class="bc-container bc-areas-of-practice bc-has-border-rad bc-has-ampersand">
			<svg id="ampersand-disc" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
			...
			<svg id="border-radius-top-right" role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
				<defs>
					<style>.cls-1{fill:none;}</style>
				</defs>
				<title>A graphical element which adds a visual curve to the top right of some elements</title>
			...
			<article class="bc-content-component bc-match-height-wrap">
				<?php if (get_field('areas-of-practice-title-text') && strcmp(get_field('areas-of-practice-title-text'), '') !== 0) { ?> 
			...
			<?php if (get_field('cn-feature-header') && strcmp(get_field('cn-feature-header'), '') !== 0) {
				$cn_feature_header = get_field('cn-feature-header');
				?>
			<!-- Chinese services feature -->
			<article class="bc-content-component bc-bg-brand-primary bc-big-text-feature bc-chinese-feature">
				<div class="bc-text-component">
					<?php if (get_field('cn-feature-label') && strcmp(get_field('cn-feature-label'), '') !== 0) { ?>
					<p class="bc-content-label"><?php echo get_field('cn-feature-label') ?></p>
					<?php }//end if cn-feature-label ?>
					<div class="bc-is-cn">
						<h2 class="bc-bg-text"><?php echo $cn_feature_header; ?></h2>
						<?php if (get_field('cn-feature-sub-text') && strcmp(get_field('cn-feature-sub-text'), '') !== 0) { ?>
						<p><?php echo get_field('cn-feature-sub-text') ?></p>
						<?php }//end if cn-feature-label ?>
						<?php if (!empty(get_field('cn-feature-link') && strcmp(get_field('cn-feature-link')['title'], '') !== 0)) { 
							$cn_feature_link = get_field('cn-feature-link'); ?>
						<p class="bc-arrow-link">
							<a href="<?php echo $cn_feature_link['url']; ?>"><?php echo $cn_feature_link['title']; ?></a>
							<svg class="svg-icon">
								<use xlink:href="<?php echo get_theme_file_uri('assets/media/svg/icons/bc-svgs.svg'); ?>#arrow"></use>
							</svg>
						</p><!-- // .bc-arrow-link -->
						<?php } // end if cn-feature-link ?>
					</div><!-- // .bc-is-cn -->	
				</div><!-- // .bc-text-component -->
			</article><!-- // .bc-big-text-feature.bc-chinese-feature -->
			<?php } // end if cn-feature-header ?>
