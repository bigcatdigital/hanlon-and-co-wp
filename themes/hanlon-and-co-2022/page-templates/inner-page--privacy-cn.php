<?php
	...
	/* Template Name: CN - Privacy template */ 
	get_header();
?> 
						...
						<div><!-- // .bc-feature-header__col -->
							<form class="bc-privacy-form" name="bc-privacy-form" id="bc-privacy-form" action="" method="post">
								...
								<div class="bc-privacy-form__section">
									...
									<label for="functional-cookies">功能性cookies</label>
								</div>
								<div class="bc-privacy-form__section">
									...
									<label for="google-analytics">允许 Google 分析</label>
								</div>
								<!-- <div class="bc-privacy-form__section">
								...
								<input class="bc-button" type="submit" value="提交偏好">
							</form>		
							<script>
